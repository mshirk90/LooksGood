...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        <div class="col-md-10 pull-left">
            ...
            <asp:HyperLink NavigateUrl="~/Account/Register.aspx" runat="server" ID="RegisterHyperLink" Visible="true" CssClass="div-margin-left" ViewStateMode="Disabled">Register</asp:HyperLink>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-10">
