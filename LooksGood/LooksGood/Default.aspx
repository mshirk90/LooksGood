...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <a><h3  style="margin-bottom: 5px;"><%# DataBinder.Eval(Container.DataItem, "Title")  %></h3></a>
                        <a href='<%# 
                      ...
                      <a class="textfix">Description: <%# DataBinder.Eval(Container.DataItem, "Description")  %>
                          <h6 style="margin-bottom: 15px;">-<%# DataBinder.Eval(Container.DataItem,"UserName")  %></h6></a>
                    </div>
                </ItemTemplate>
